...
class ExercisesConc extends StatefulWidget {
  ExercisesConc(
  ...
  @override
  _ExercisesConcState createState() =>
      _ExercisesConcState(documentId, nome, image);
}

class _ExercisesConcState extends State<ExercisesConc> {
  final String documentId;
  final String nome;
  final String image;
  ...
  _ExercisesConcState(this.documentId, this.nome, this.image);
