              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage("assets/homem.png"),fit: BoxFit.cover
                    ), 
                ),
               ),
               SizedBox(
               ...
               Column(
                 crossAxisAlignment: CrossAxisAlignment.start,
                 children: <Widget>[
                   Text("Carlos Dias Ernandes",style: TextStyle(fontSize: 20.0),),
                   SizedBox(
                     height:10,
                   ),
                   Container(
                     ...
                     child: Center(child: Text("Edit",style: TextStyle(color: Colors.white, fontSize: 12.0),),),
                   ),
                 ],
               ),
             ],
            ...
            Text(
              ...
              Card(
                ...
                child: Column(
                  children: <Widget>[
                    ListTile(
                      leading: Icon(Icons.assignment_turned_in_sharp, color: Colors.black,),
                      title: Text("Training", style: TextStyle(fontSize: 19.0),),
                      onTap: (){},
                    ),
                    Divider(height:10.0,color: Colors.grey),
                    ListTile(
                      leading: Icon(Icons.vpn_key, color: Colors.black),
                      title: Text("Change Password", style: TextStyle(fontSize: 19.0),),
                      onTap: (){},
                    ),
                    Divider(height:10.0,color: Colors.grey),
                    ListTile(
                      leading: Icon(Icons.verified, color: Colors.black),
                      title: Text("Upgrade Account", style: TextStyle(fontSize: 19.0),),
                      onTap: (){}, 
                    ),
                    Divider(height:10.0,color: Colors.grey),
                    ListTile(
                      leading: Icon(Icons.headset_mic, color: Colors.black),
                      title: Text("Support", style: TextStyle(fontSize: 19.0),),
                      onTap: (){},
                    ),
                  ],
                ),
